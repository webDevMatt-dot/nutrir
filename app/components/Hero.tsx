            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative flex justify-center lg:justify-end">
                        ...
                        {/* Floating "Quality" Card - HIDDEN on mobile, visible on lg+ */}
                        <div className="hidden lg:flex absolute bottom-10 -left-10 bg-white p-4 rounded-xl shadow-lg items-center gap-4 w-max max-w-[200px] animate-in slide-in-from-bottom duration-1000 z-30">
